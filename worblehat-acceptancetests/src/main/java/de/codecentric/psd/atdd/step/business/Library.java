...
public class Library {
	...
	public void createSingleBook(@Named("isbn") String isbn)
			throws SQLException {
		emptyLibrary();
		database.execute("INSERT INTO Book(id,title,author,edition,isbn,year, description) VALUES "
				+ "(0, 'Title', 'Author', '1', '"
				+ isbn
				+ "', 2011, 'Eine Beschreibung')");
	}
	...
	public void createListOfBorrowedBooks(@Named("user") String user,
		...
		for (String isbn : isbnList) {
			database.execute("INSERT INTO Book(title,author,edition,isbn,year, description) VALUES "
					+ "('Title', 'Author', '1', '"
					+ isbn
					+ "', 2011, 'Eine Beschreibung')");
